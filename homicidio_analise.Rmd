...
Os dados fornecidos pela Secretaria limitam-se ao anos 2017-2022, e por isso a análise será deste ciclo temporal.

A análise foi realizada com a linguagem R. Todo o código utilizado para gerar esse estudo pode ser encontrado no meu [github](https://github.com/martinscaio/Homicidios-Dolosos)
...
homicidio <- read_csv("C:\\Users\\Caio\\Desktop\\Projeto - Homicidios Dolosos\\dados_prontos\\homicidio_geral.csv")
...
Como podemos observar há um declínio no número de vítimas de homicídios dolosos nos últimos anos.  
O ano de 2022 registrou 582 casos, o menor registro dos últimos 5 anos.  
...
#### Comparativo do Nº de vítimas de homicídios dolosos por mês/ano na cidade de SP




```{r d, echo=FALSE, message=FALSE, warning=FALSE, out.width = '73%'}
...
##### Tabela com o número de casos por mês/ano



```{r, echo=FALSE, message=FALSE, warning=FALSE, out.width = '73%'}
...
Abaixo uma tabela com o número vítimas de Homicídios Dolosos (2017-2022) por Delegacia/Distrito policial. É possível ordenar descendente/ascendente clicando em cada ano. Também é possível pesquisar pelo nome caso queira.
...
knitr::include_graphics("C:\\Users\\Caio\\Desktop\\Projeto - Homicidios Dolosos\\imagens_graficos\\teste2.png")
...
html_content2 <- readLines("C:\\Users\\Caio\\Desktop\\Projeto - Homicidios Dolosos\\imagens_graficos\\widget_i.html", warn = FALSE)
...
homicidio_georeferenciado <- read_csv("C:\\Users\\Caio\\Desktop\\Projeto - Homicidios Dolosos\\dados_prontos\\homicidio_georreferenciado.csv")
